  ...
  <div>
    ...
    <div className="row">
      ...
      <div className="column_2">
          ...
          <h1 className='text_h1'><b>{companyDetails.name}</b></h1>
          <p>{companyDetails.description}</p>
          <br></br>
          <p><b>Cost to Company </b>{companyDetails.ctc}</p>
          <br>
          </br>
          <p><b>Location : </b> The employees would be routed to the branch of {companyDetails.Location}</p>
          <br></br>
          <p><b>Roles : </b>The fresher would be assigned the role of {companyDetails.Roles} 1</p>
          <br></br>
