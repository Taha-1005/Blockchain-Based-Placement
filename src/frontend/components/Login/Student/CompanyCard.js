...
const CompanyCard = ({ companyData,studentData }) => {
  console.log("comp data, ",companyData.location,companyData.name,studentData);
  ...
  return (
    <Link
      ...
      state={{ data: companyData, studentId:studentData}}
    >
